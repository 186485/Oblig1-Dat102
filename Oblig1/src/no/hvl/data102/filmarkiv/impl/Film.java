...
public class Film {
	...
	private Film(int filmnr, String produsent, String tittel, int lansering, String sjanger, String filmselskap) {
		this.Filmnr = filmnr;
...
Film N1 = new Film();
Film N2 = new Film(Filmnr, Produsent, Tittel, Lansering, s, FilmSelskap);
